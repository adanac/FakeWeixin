 ...
 * @version 1.0
 */
public class MoreTabEMSYActivity extends FragmentActivity implements
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						MoreTabEMSYActivity.this.finish();
					}
				});
	}
	...
	public void onStart() {
		...
		if (!file.exists()) {
			// Down Video
			String downPath = "http://adanac.qiniudn.com/app%E6%91%84%E5%BD%B11.wmv";
			DownFileUtil.downMedia(savePath, filename, downPath);
			DownFileUtil.toastDisplay(MoreTabEMSYActivity.this, "缓冲中...", 5000);
			try {
				Thread.sleep(3000);
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			MoreFragmentEMXDSJ fragment = new MoreFragmentEMXDSJ();
			Bundle bundle = new Bundle();
			bundle.putInt(MoreFragmentEMXDSJ.INTENT_INT_INDEX, position);
