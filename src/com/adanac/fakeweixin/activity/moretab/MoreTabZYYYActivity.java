 ...
 * @version 1.0
 */
public class MoreTabZYYYActivity extends FragmentActivity implements
	...
	// 顶部标题
	private TextView moretab_zyyy_top;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.moretab_zyyy);
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						MoreTabZYYYActivity.this.finish();
					}
				});
	}
	...
	private void initBottomView() {
		...
		// 顶部标题
		this.moretab_zyyy_top = (TextView) findViewById(R.id.moretab_zyyy_top);
	...
	public void onStart() {
		...
		if (!file.exists()) {
			// Down Video
			String downPath = "http://adanac.qiniudn.com/app%E8%B5%84%E6%BA%90%E7%9A%84%E8%BF%90%E7%94%A8.wmv";
			DownFileUtil.downMedia(savePath, filename, downPath);
			DownFileUtil.toastDisplay(MoreTabZYYYActivity.this, "缓冲中...", 5000);
			try {
				Thread.sleep(3000);
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			MoreFragmentZYYY fragment = new MoreFragmentZYYY();
			Bundle bundle = new Bundle();
			bundle.putInt(MoreFragmentZYYY.INTENT_INT_INDEX, position);
