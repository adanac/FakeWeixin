 ...
 * @version 1.0
 */
public class MoreTabEMXDSJActivity extends FragmentActivity implements
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						MoreTabEMXDSJActivity.this.finish();
					}
				});
	}
	...
	public void onStart() {
		...
		if (!file.exists()) {
			...
			DownFileUtil.toastDisplay(MoreTabEMXDSJActivity.this, "缓冲中...",
					5000);
			try {
				Thread.sleep(3000);
