 ...
 * @version 1.0
 */
public class MoreTabFHNHActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.moretab_fhnh);
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						MoreTabFHNHActivity.this.finish();
					}
				});
	}
	...
	public void onStart() {
		...
		if (!file.exists()) {
			// Down Video
			String downPath = "http://adanac.qiniudn.com/app%E7%AC%A6%E5%8F%B7%E7%9A%84%E5%86%85%E6%B6%B5.wmv";
			DownFileUtil.downMedia(savePath, filename, downPath);
			DownFileUtil.toastDisplay(MoreTabFHNHActivity.this, "缓冲中...", 5000);
			try {
				Thread.sleep(3000);
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			MoreFragmentFHNH fragment = new MoreFragmentFHNH();
			Bundle bundle = new Bundle();
			bundle.putInt(MoreFragmentFHNH.INTENT_INT_INDEX, position);
