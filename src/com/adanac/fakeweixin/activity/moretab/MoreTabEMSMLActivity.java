 ...
 * @version 1.0
 */
public class MoreTabEMSMLActivity extends FragmentActivity implements
	...
	// 顶部标题
	private TextView moretab_emsml_top;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.moretab_emsml);

		ViewPager viewPager = (ViewPager) findViewById(R.id.moretab_viewPager_emsml);
		indicator = (ScrollIndicatorView) findViewById(R.id.moretab_indicator_emsml);
		...
		mVideoView = (VideoView) findViewById(R.id.videoview_emsml);
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						MoreTabEMSMLActivity.this.finish();
					}
				});
	}
	...
	private void initBottomView() {
		...
		// 顶部标题
		this.moretab_emsml_top = (TextView) findViewById(R.id.moretab_emsml_top);
	...
	public void onStart() {
		...
		if (!file.exists()) {
			// Down Video
			String downPath = "http://adanac.qiniudn.com/app%E6%B0%B4%E5%A2%A8%E7%94%BB1.wmv";
			DownFileUtil.downMedia(savePath, filename, downPath);
			DownFileUtil
					.toastDisplay(MoreTabEMSMLActivity.this, "缓冲中...", 5000);
			try {
				Thread.sleep(3000);
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			MoreFragmentEMSML fragment = new MoreFragmentEMSML();
			Bundle bundle = new Bundle();
			bundle.putInt(MoreFragmentEMSML.INTENT_INT_INDEX, position);
