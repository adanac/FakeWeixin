 ...
 * @version 1.0
 */
public class MoreTabEZGXActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.moretab_ezgx);
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						MoreTabEZGXActivity.this.finish();
					}
				});
	}
	...
	public void onStart() {
		...
		if (!file.exists()) {
			// Down Video
			String downPath = "http://adanac.qiniudn.com/app%E8%A7%86%E8%A7%89%E7%B4%A0%E5%85%BB%E4%B8%8E%E5%AA%92%E4%BB%8B%E7%B4%A0%E5%85%BB%E7%9A%84%E5%85%B3%E7%B3%BB.wmv";
			DownFileUtil.downMedia(savePath, filename, downPath);
			DownFileUtil.toastDisplay(MoreTabEZGXActivity.this, "缓冲中...", 5000);
			try {
				Thread.sleep(3000);
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			MoreFragmentEZGX fragment = new MoreFragmentEZGX();
			Bundle bundle = new Bundle();
			bundle.putInt(MoreFragmentEZGX.INTENT_INT_INDEX, position);
