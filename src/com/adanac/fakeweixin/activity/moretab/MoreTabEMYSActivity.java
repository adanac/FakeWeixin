 ...
 * @version 1.0
 */
public class MoreTabEMYSActivity extends FragmentActivity implements
	...
	// 顶部标题
	private TextView moretab_emys_top;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.moretab_emys);

		ViewPager viewPager = (ViewPager) findViewById(R.id.moretab_viewPager_emys);
		indicator = (ScrollIndicatorView) findViewById(R.id.moretab_indicator_emys);
		...
		mVideoView = (VideoView) findViewById(R.id.videoview_emys);
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						MoreTabEMYSActivity.this.finish();
					}
				});
	}
	...
	private void initBottomView() {
		...
		// 顶部标题
		this.moretab_emys_top = (TextView) findViewById(R.id.moretab_emys_top);
	...
	public void onStart() {
		...
		if (!file.exists()) {
			// Down Video
			String downPath = "http://adanac.qiniudn.com/app%E5%BD%B1%E8%A7%861.wmv";
			DownFileUtil.downMedia(savePath, filename, downPath);
			DownFileUtil.toastDisplay(MoreTabEMYSActivity.this, "缓冲中...", 5000);
			try {
				Thread.sleep(3000);
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			MoreFragmentEMYS fragment = new MoreFragmentEMYS();
			Bundle bundle = new Bundle();
			bundle.putInt(MoreFragmentEMYS.INTENT_INT_INDEX, position);
