 ...
 * @version 1.0
 */
public class MoreTabYYCCActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.moretab_yycc);
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						MoreTabYYCCActivity.this.finish();
					}
				});
	}
	...
	public void onStart() {
		...
		if (!file.exists()) {
			// Down Video
			String downPath = "http://adanac.qiniudn.com/app%E6%84%8F%E4%B9%89%E6%89%80%E6%8C%87%E5%B1%82%E6%AC%A1%E5%9B%BE.wmv";
			DownFileUtil.downMedia(savePath, filename, downPath);
			DownFileUtil.toastDisplay(MoreTabYYCCActivity.this, "缓冲中...", 5000);
			try {
				Thread.sleep(3000);
