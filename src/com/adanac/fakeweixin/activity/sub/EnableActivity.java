...
public class EnableActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.enable_content);
	...
	private void initView() {
		...
		// 顶部标题
		this.enable_top = (TextView) findViewById(R.id.enable_top);
		...
		// 适配器
		View page_01 = View
				.inflate(EnableActivity.this, R.layout.page_01, null);
		View page_02 = View
				.inflate(EnableActivity.this, R.layout.page_02, null);
		View page_03 = View
				.inflate(EnableActivity.this, R.layout.page_03, null);
		View page_04 = View
				.inflate(EnableActivity.this, R.layout.page_04, null);
