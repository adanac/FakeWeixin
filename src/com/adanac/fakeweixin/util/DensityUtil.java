...
public class DensityUtil {
	...
	public static void addOnSoftKeyBoardVisibleListener(
			final Activity activity, final ScrollView scrollView) {
							...
							mHandler.postDelayed(new Runnable() {
								...
								public void run() {
									...
									scrollView.scrollTo(0,
											DensityUtil.dip2px(activity, 167));
								}
							}, 50);
						}
					}
	...
	public static String getEllipsisedText(TextView textView) {
		try {
			...
			if (spos < len) {
				result.append(TextUtils.ellipsize(text.subSequence(spos, len),
						paint, (float) width, where));
			}
