...
public class SlideViewSY extends LinearLayout {
	...
	public SlideViewSY(Context context) {
		super(context);
		initView();
	}

	public SlideViewSY(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	...
	private void initView() {
		...
		View.inflate(mContext, R.layout.slide_view_merge_four_sy, this);
