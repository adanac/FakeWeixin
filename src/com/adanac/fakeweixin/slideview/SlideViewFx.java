...
public class SlideViewFx extends LinearLayout {
	...
	public SlideViewFx(Context context) {
		super(context);
		initView();
	}

	public SlideViewFx(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	...
	private void initView() {
		...
		View.inflate(mContext, R.layout.slide_view_merge_fx, this);
