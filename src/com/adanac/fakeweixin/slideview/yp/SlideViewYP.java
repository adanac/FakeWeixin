...
public class SlideViewYP extends LinearLayout {
	...
	public SlideViewYP(Context context) {
		super(context);
		initView();
	}

	public SlideViewYP(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	...
	private void initView() {
		...
		View.inflate(mContext, R.layout.slide_view_merge_four_sf, this);
		mViewContent = (LinearLayout) findViewById(R.id.view_content_four_sf);
	...
	public void setButtonText(CharSequence text) {
		((TextView) findViewById(R.id.delete_four_sf)).setText(text);
	}
