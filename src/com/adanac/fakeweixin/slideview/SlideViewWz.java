...
public class SlideViewWz extends LinearLayout {
	...
	public SlideViewWz(Context context) {
		super(context);
		initView();
	}

	public SlideViewWz(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	...
	private void initView() {
		...
		View.inflate(mContext, R.layout.slide_view_merge_wz, this);
