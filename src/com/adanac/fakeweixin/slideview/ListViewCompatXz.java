...
public class ListViewCompatXz extends ListView {
    ...
    public ListViewCompatXz(Context context) {
        super(context);
    }

    public ListViewCompatXz(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ListViewCompatXz(Context context, AttributeSet attrs, int defStyle) {
