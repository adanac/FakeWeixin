...
public class SlideViewYS extends LinearLayout {
	...
	public SlideViewYS(Context context) {
		super(context);
		initView();
	}

	public SlideViewYS(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	...
	private void initView() {
		...
		View.inflate(mContext, R.layout.slide_view_merge_four_qt, this);
