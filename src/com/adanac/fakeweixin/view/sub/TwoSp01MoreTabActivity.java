 ...
 * @version 1.0
 */
public class TwoSp01MoreTabActivity extends FragmentActivity {
	private IndicatorViewPager indicatorViewPager;
	private LayoutInflater inflate;
	private String[] names = { "教学微视频之“符号的内涵”", "教学微视频之“媒介素养的内涵”", "学生微电影作品" };
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						TwoSp01MoreTabActivity.this.finish();
					}
				});
	}
