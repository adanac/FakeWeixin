 ...
 * @version 1.0
 */
public class ThreeMjMoreFragment extends LazyFragment implements
	...
	protected void onCreateViewLazy(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_tabmain_three_mj);
		tabIndex = getArguments().getInt(INTENT_INT_INDEX);
		progressBar = (ProgressBar) findViewById(R.id.fragment_mainTab_three_mj_progressBar);
		textView = (TextView) findViewById(R.id.fragment_mainTab_three_mj_textView);
