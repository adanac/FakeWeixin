 ...
 * @version 1.0
 */
public class ThreeMjMoreTabActivity extends FragmentActivity {
	...
	// 顶部标题
	private TextView moretab_three_mj_top;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.moretab_three_mj);
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						ThreeMjMoreTabActivity.this.finish();
					}
				});
	}
	...
	private void initBottomView() {
		...
		// 顶部标题
		this.moretab_three_mj_top = (TextView) findViewById(R.id.moretab_three_fx_top);
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			ThreeMjMoreFragment fragment = new ThreeMjMoreFragment();
			Bundle bundle = new Bundle();
			bundle.putInt(ThreeMjMoreFragment.INTENT_INT_INDEX, position);
