	...
	protected void onCreateViewLazy(Bundle savedInstanceState) {
		...
		case 0:
			textView.setText(Html
					.fromHtml("<b>\t\t\t\t\t\t\t学生作品之《易经》</b><br/>\t\t\t\t\t\t来源：视觉文化网\t\t\t\t\t\t时间：2015.12.18<br/>\t"
							...
							+ "（相关作品链接：<a href=\"http://www.fromeyes.cn/ZhuanTi/sjwhzy/jiaoji/\">http://www.fromeyes.cn/ZhuanTi/sjwhzy/jiaoji/</a>）"));
		...
		case 1:
			textView.setText(Html
					.fromHtml("<b>\t\t\t\t\t\t\t学生作品之《古乐灵音》</b><br/>\t\t\t\t\t\t\t\t\t\t\t来源：视觉文化网                    时间：2015.12.18<br/>\t作品《古乐灵音》是南京师范大学2011级现代教育技术硕士共同创作的。中国传统乐器作为中国传统文化中不可分割的一个组成部分，源远流长，他们希望通过自己的绵薄之力，利用信息技术手段来展现中国传统乐器文化的魅力，而哪怕只能展现其魅力之一。作品包含了编钟、古琴、古筝、月琴、琵琶、二胡、笛、萧、埙和鼓。中国传统乐器文化作为中华文化的一部分，是不能被大家遗忘和舍弃的。在这里，望有志之士充分发挥聪明才智，挖掘古乐文化精髓，使我中华文化生辉于世界文化之中，使我中华文化屹立于世界之巅。（相关作品链接：http://www.fromeyes.cn/ZhuanTi/sjwhzy/2011级专业硕士古灵音乐/index.html）"));
		...
		case 2:
			textView.setText(Html
					.fromHtml("<b>\t\t\t\t\t学生对作品《太阳的睫毛》的解读</b><br/>\t\t\t\t\t\t\t来源：视觉文化网                    时间：2015.12.18 \n请欣赏下面的作品，通过自己的学习体验以及丰富的想象力，运用所指意义层次图表达自己的想法吧。"));
