 ...
 * @version 1.0
 */
public class TwoYp01MoreTabActivity extends FragmentActivity {
	private IndicatorViewPager indicatorViewPager;
	private LayoutInflater inflate;
	private String[] names = { "二胡", "古琴", "琵琶" };
	...
	// 顶部标题
	private TextView moretab_two_yp_top;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.moretab_two_yp);
		...
		findViewById(R.id.moretab_iv_back).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						// 使当前Activity结束就可以了
						TwoYp01MoreTabActivity.this.finish();
					}
				});
	}
	...
	private void initBottomView() {
		...
		// 顶部标题
		this.moretab_two_yp_top = (TextView) findViewById(R.id.moretab_two_yp_top);
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			TwoYp01MoreFragment fragment = new TwoYp01MoreFragment();
			Bundle bundle = new Bundle();
			bundle.putInt(TwoYp01MoreFragment.INTENT_INT_INDEX, position);
